...
async function PI() {
  ...
  try {
    ...
    if (await driver.findElement(By.css("img[src*='cross.png']"))) {
      await driver.findElement(By.css("img[src*='cross.png']")).click();
      await driver.sleep(1000);
    }

    let dados = await driver.findElements(
      By.xpath("//div[@class='post-content']//p")
    );
